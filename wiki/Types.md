This list of types is unique in how it is used and how the application interacts with them. Each element is defined by its type, whereas its name does not affect it.
